...
public class Diabetic_DDT extends BaseClass {
...
//				By.xpath("// html/body/div[2]/form/div[3]/div[2]/div/div[1]/div[1]/div[2]/a["+x+"]")); /// html/body/div[2]/form/div[3]/div[2]/div/div[1]/div[1]/div[2]/a['"+j+"']
//				//*[@id='cardholder']/div[2]/a["+x+"]
//				Thread.sleep(1000);
//				WaitForElement(pagei);
//				System.out.println("test1" + pagei.getText());
////				pagei.click();
...
//					WebElement pagei = driver.findElement(
////					By.xpath("//div[@id='cardholder']//div[@style='text-align:right;padding-bottom:15px;']/a[@class='respglink'] and text()='"+x+"']")); /// html/body/div[2]/form/div[3]/div[2]/div/div[1]/div[1]/div[2]/a['"+j+"']
//					By.xpath("//*[@id='cardholder']/div[3]/a["+x+"]")); /// html/body/div[2]/form/div[3]/div[2]/div/div[1]/div[1]/div[2]/a['"+j+"']
//
//					System.out.println("test1" + pagei.getText());
//					Thread.sleep(1000);
...
//						}
					...
					if (searchinput.equalsIgnoreCase("Vegan Diabetic")) {
						try {
							common.writeDataToExcel(scrapedData, "VeganDiabeticRecipes", searchinput);
						} catch (IOException e) {
						...
						else if (searchinput.equalsIgnoreCase("Vegan Recipes")) {
						
						try {
							common.writeDataToExcel(scrapedData, "Vegan_recipes", searchinput);
						} catch (IOException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						} catch (Exception e) {
							...
							try {
								common.writeDataToExcel(scrapedData, "Diabetic_recipes", searchinput);
							} catch (IOException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							} catch (Exception e) {
