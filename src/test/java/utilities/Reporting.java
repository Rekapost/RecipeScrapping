...
public class Reporting extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter=new ExtentHtmlReporter("C:/Users/Reka/eclipse-workspace/webscrapping/test-output/"+repName);
		
		try {
			//htmlReporter.loadXMLConfig(System.getProperty("user.dir")+"/extent-config.xml");
			htmlReporter.loadXMLConfig("C:\\Users\\Reka\\eclipse-workspace\\webscrapping\\extent_config.xml");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		htmlReporter.config().setDocumentTitle("Indeed WebScrapping Test Project");//title of report
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		String screenshotPath="C:\\Users\\Reka\\eclipse-workspace\\webscrapping\\Screenshots\\Screenshots"+tr.getName()+".png";
