...
public class samplediabetic extends BaseClass{
...
*/	
		//  ************************ CREATE EXCEL SHEET  WITH COLUMN HEADING ***************
				...
				for(int i=1;i<=noOfRows;i++) {
				 reader.setCellData("VeganDiabetic", 0, 0, "Recipe ID"); 
				 reader.setCellData("VeganDiabetic", 0, 1, "Recipe Name");
				 reader.setCellData("VeganDiabetic", 0, 2, "Page Title");
				 reader.setCellData("VeganDiabetic", 0, 3, "Vegan Diabetic Food Category");
				 reader.setCellData("VeganDiabetic", 0, 4, "Ingredients");
				 reader.setCellData("VeganDiabetic", 0, 5, "RecipePrepTime");
				 reader.setCellData("VeganDiabetic", 0, 6, "RecipeCookTime");
				 reader.setCellData("VeganDiabetic", 0, 7, "Preparation Method");
				 reader.setCellData("VeganDiabetic", 0, 8, "Nutrient values");
				 reader.setCellData("VeganDiabetic", 0, 9, "Targetted morbid conditions (Diabeties/Hypertension/Hypothyroidism)");
				 reader.setCellData("VeganDiabetic", 0, 10, "Recipe URL");
				} 	
...
//		    *************** WRITING DATA INTO EXCEL ***********************************	
							...
							//js.executeScript("arguments[0].click()", recipeTitle);			
							reader.setCellData("VeganDiabetic", r, 1, title);
							reader.setCellData("VeganDiabetic", r, 2, pageTiltle);				
							//reader.setCellData("Sheet5", r, 2, RecpieCategory);
							//reader.setCellData("Sheet5", r, 3, FoodCategory);
							reader.setCellData("VeganDiabetic", r, 4,RecpieIngredients );
							reader.setCellData("VeganDiabetic", r, 5, prep_time);
							reader.setCellData("VeganDiabetic", r, 6, cook_time);
							reader.setCellData("VeganDiabetic", r, 7, method);
							reader.setCellData("VeganDiabetic", r, 8,Nutritionlist);
							reader.setCellData("VeganDiabetic", r, 9, morbid_condition);
							reader.setCellData("VeganDiabetic", r, 10, url);				
							...
							int k=1;
							 for (String eachIDList : recipeIDList ) {
								...
								reader.setCellData("VeganDiabetic", k, 0, eachRecipeID);
								k++;
